...
if __name__ == '__main__':
    ...
    with open('to_run.out', 'r') as f:
        for line in f:
            ...
            os.system(f"sed -e \"s/ID/{pdb_id}/g\" </home/alexjli/TERMinator/postprocessing/fix_dTERMen.sh >/scratch/users/alexjli/TERMinator/fixed_dTERMen/{pdb_id}/fix_{pdb_id}.sh")
